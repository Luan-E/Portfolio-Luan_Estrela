...
const Hero = () => {
    return (
        // Container principal
        <section id='inicio' className='w-full min-h-screen bg-slate-950 text-white flex items-center pt-16 overflow-hidden relative'>
            ...
            <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-6 w-full z-10 py-12 md:py-0'>
                {/* Grid adaptável */}
                <div className='grid grid-cols-1 md:grid-cols-2 gap-8 gap-12 items-center'>
                    
                    {/* Coluna da Esquerda: Textos e Botões */}
                    <div className='md:col-start-1 md:row-start-1 flex flex-col space-y-6 text-center md:text-left animate-fade-in'>
                    ...
                    <div className='md:col-start-2 md:row-start-1 md:row-span-2 flex justify-center items-center relative'>
                    ...
                    {/* Botões */}
                    <div className='md:col-start-1 md:row-start-2 flex flex-col sm:flex-row items-center justify-center md:justify-start gap-4 pt-4'>
